...
router.post("/:id/send-to-courier", requireAuth, requireAdmin, async (req, res) => {
  ...
  try {
    ...
    if (entry.group_name === "exchange") {
      deliveryNote =
        "এই পার্সেলটি এক্সচেঞ্জ হবে, ডেলিভারি দেখাবেন না পার্শিয়াল দেখাবেন। আপনার কাছে থাকা পার্সেলে যা যা আছে ঠিক তাই এক্সচেঞ্জ আসবে, কাস্টমারকে আপনি পার্সেল খুলে বুঝিয়ে দিবেন, তারপর আপনারটি বুঝে নিবেন। যেকোনো প্রয়োজনে অবশ্যই মার্চেন্টকে কল দিবেন।";
