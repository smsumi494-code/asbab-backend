...
router.post("/", requireAuth, async (req, res) => {
  ...
  try {
    ...
    // Notify everyone else — after responding, so posting itself isn't
    // slowed down waiting on notification delivery.
    const groupTitles = { pending: "Pending", all_order: "All Order", making: "Making" };
    notifyAll(
      {
